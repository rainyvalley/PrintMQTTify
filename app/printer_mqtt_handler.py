...
def generate_pdf(title, message):
    ...
    try:
        ...
        page_height = 200 * mm  # Initial height for debugging
        ...
        # Debug: Verify canvas creation
        print(f"Canvas created with dimensions {page_width}x{page_height}")
        ...
        for line in title_lines:
            y -= 14
            if y < margin:  # Avoid drawing below the margin
                break
            print(f"Drawing title line '{line}' at y={y}")
        ...
        for line in message_lines:
            ...
            if y < margin:
                break
            print(f"Drawing message line '{line}' at y={y}")
            c.drawString(margin, y, line)
